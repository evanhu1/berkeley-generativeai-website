...
export default function Home() {
  return (
    <div className="flex flex-col text-white place-items-center h-full">
      <div className={"mt-12 w-2/3 flex flex-col text-center place-items-center text-4xl md:text-7xl leading-[1] " + font.className}>
        ...
        <a
            ...
            aria-current="page"
        >
            <button className="mt-16 px-4 py-1 md:px-8 md:py-3 text-lg text-white bg-gradient-to-br from-[#036CD4] to-[#d152e2] rounded-lg hover:bg-[#0b6e71] focus:outline-none focus:ring-2 focus:ring-blue-200">
              Apply
            </button>
        </a>
        <a
            ...
            aria-current="page"
        >
            <button className="px-4 py-1 md:px-8 md:py-3 text-lg text-white bg-[#036CD4] rounded-lg hover:bg-[#0b6e71] focus:outline-none focus:ring-2 focus:ring-blue-200">
              About
            </button>
        </a>
