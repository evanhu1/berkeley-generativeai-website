    ...
    <div className="flex flex-col text-white place-items-center h-full mt-12">
      <div className={"mt-12 w-2/3 flex flex-col text-center place-items-center text-4xl md:text-7xl leading-[1] " + font.className}>
        ...
        <a
            ...
            aria-current="page"
        >
            <button className="mt-16 px-4 py-1 md:px-8 md:py-2 text-lg text-white bg-purple-500/50 rounded-lg hover:bg-purple-200/50 focus:outline-none focus:ring-2 focus:ring-blue-200">
              Apply
            </button>
        </a>
        <a
            ...
            aria-current="page"
        >
            <button className="px-4 py-1 md:px-8 md:py-3 text-lg text-white bg-purple-500/50 rounded-lg hover:bg-purple-200/50 focus:outline-none focus:ring-2 focus:ring-blue-200">
              About
            </button>
        </a>
